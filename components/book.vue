	...
	<view>
		<view class="card">
			<view>
				...
				overflow: hidden;text-overflow: ellipsis;margin-bottom: 25upx;color: rgba(102,205,170,1);">{{address}}</view>
				...
				<view style="display: flex;margin-bottom: 25upx;">
					...
					<view style="font-size: 35upx;font-weight: 700;color:rgba(102,205,170,1) ;letter-spacing: 3upx;">￥{{price}}</view>
				</view>
				...
				<view style="width: 100%;height: 70upx;display: flex;justify-content: center;align-items: center;">
					<view style="width: 400upx;display: flex;justify-content: space-between;">
						...
						display: flex;justify-content: center;align-items: center;" :style="{'background-color':color}" @tap="check()">
