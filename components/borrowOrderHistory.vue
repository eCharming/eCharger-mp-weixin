		...
		<view style="display: flex;justify-content: center;">
			<view style="width: 450upx;display: flex;justify-content: space-between;">
				...
				<view style="height: 70upx;width: 170upx;color: white;
					font-size: 28upx;font-weight: 700;letter-spacing: 2upx;border-radius: 25upx;
					display: flex;justify-content: center;align-items: center;" :style="{'background-color':checkColor}" @tap="check">
					{{checkStatus}}
				</view>
			</view>
			
		</view>
		<image src="../static/image/orderHistory-blue.png" style="width: 300upx;height: 300upx;position: absolute;right: -10upx;bottom: 120upx;opacity: 0.3;"></image>
	</view>
</template>
